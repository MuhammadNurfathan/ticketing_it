                ...
                <table class="datatable min-w-full border border-gray-300 dark:border-gray-600 text-sm">
                    <thead class="bg-light-eval-2 dark:bg-dark-eval-2 text-left">
                        <tr>
                            ...
                            <th class="border border-gray-300 dark:border-gray-600 p-2 text-light-text dark:text-dark-text">Ticket</th>
                            <th class="border border-gray-300 dark:border-gray-600 p-2 text-light-text dark:text-dark-text">Deskripsi</th>
                            <th class="border border-gray-300 dark:border-gray-600 p-2 text-light-text dark:text-dark-text">Rating</th>
                            ...
                            <tr class="hover:bg-light-eval-2 dark:hover:bg-dark-eval-2">
                                ...
                                <td class="border border-gray-300 dark:border-gray-600 p-2 text-light-text dark:text-dark-text">
                                    <div class="flex space-x-2">
                                        ...
                                        <form action="{{ route('departments.destroy', $department) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus department ini?');">
                                            @csrf
                                            @method('DELETE')
