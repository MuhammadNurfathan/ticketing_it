                ...
                <div class="p-6 text-gray-900">
                    ...
                    @endif
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="check_in" value="{{ old('check_in', $asset->check_in) }}"
                                class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white rounded-md shadow-sm px-3 py-2"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="check_out" value="{{ old('check_out', $asset->check_out) }}"
                                class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white rounded-md shadow-sm px-3 py-2"
                                placeholder="Contoh: -">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="check_out_to" value="{{ old('check_out_to', $asset->check_out_to) }}"
                                class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white rounded-md shadow-sm px-3 py-2"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white rounded-md shadow-sm px-3 py-2" rows="3">{{ old('notes',$asset->notes) }}</textarea>
                        </div>
